_base_ = [
    '../_base_/models/phrnet/phrnet-w72s.py',
    '../_base_/datasets/imagenet_bs32_pil_resize.py',
    '../_base_/schedules/imagenet_bs256_100e_coslr_warmup.py',
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend',
                     init_kwargs=dict(
                         ...
                         name='phrnet-w72s_8xb32_in1k_warmupEP-100',       # experiment name
                         tags=['phrnet', 'classification', 'imagenet'],
                         notes='PHRNet-W72s training on ImageNet-1K'
                     ),
                     )]
visualizer = dict(type='UniversalVisualizer', vis_backends=vis_backends)

custom_hooks = [
    dict(type='GradientLoggingHook', log_interval=10)
]
